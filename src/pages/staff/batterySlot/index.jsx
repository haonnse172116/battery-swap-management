...
import { useGetStationSlotsQuery, useRegisterSlotMutation, useDeleteSlotMutation, useUpdateSlotMutation } from '@/services/stationBatterySlot.service';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="space-y-2 p-2 bg-white border rounded h-[60vh] overflow-auto">
                                ...
                                {(slots || []).sort((a, b) => Number(a.slotNo) - Number(b.slotNo)).map(s => {
                                            ...
                                            <div className="flex-col gap-2">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <button className="px-3 py-1 bg-red-500 text-white rounded" onClick={async () => {
                                                        ...
                                                        try {
                                                            await toast.promise(deleteSlot(s.id).unwrap(), {
                                                                loading: 'Đang xóa...',
